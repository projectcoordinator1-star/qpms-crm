...
export const leadRows = [
  {
    ...
    contact: 'Rohit Nair',
    contacts: [
      { id: 'contact-1a', name: 'Rohit Nair', designation: 'Facility Manager', phone: '+91 98765 21001', email: 'rohit.nair@example.com', isPrimary: true },
      { id: 'contact-1b', name: 'Anita George', designation: 'Admin Lead', phone: '+91 98765 21002', email: 'anita.george@example.com', isPrimary: false },
    ],
    source: 'Referral',
    executive: 'Ananya Rao',
    assigned_bd_executive: 'Ananya Rao',
    assigned_bd_email: 'bd1@qpms.co.in',
    created_by_user_id: 'bd-1',
  ...
  },
  {
    ...
    contact: 'Meera Shah',
    contacts: [
      { id: 'contact-2a', name: 'Meera Shah', designation: 'Facilities Director', phone: '+91 98765 22001', email: 'meera.shah@example.com', isPrimary: true },
      { id: 'contact-2b', name: 'Farhan Ali', designation: 'Operations Manager', phone: '+91 98765 22002', email: 'farhan.ali@example.com', isPrimary: false },
      { id: 'contact-2c', name: 'Latha Menon', designation: 'Procurement', phone: '+91 98765 22003', email: 'latha.menon@example.com', isPrimary: false },
    ],
    source: 'Website',
    executive: 'Karthik Menon',
    assigned_bd_executive: 'Karthik Menon',
    assigned_bd_email: 'bd2@qpms.co.in',
    created_by_user_id: 'bd-2',
    created_by_name: 'Karthik Menon',
  ...
  },
  {
    ...
    contact: 'Imran Khan',
    contacts: [
      { id: 'contact-3a', name: 'Imran Khan', designation: 'Property Head', phone: '+91 98765 23001', email: 'imran.khan@example.com', isPrimary: true },
    ],
    source: 'Outbound',
    executive: 'Nisha Iyer',
    assigned_bd_executive: 'Nisha Iyer',
    assigned_bd_email: 'bd3@qpms.co.in',
    created_by_user_id: 'bd-3',
    created_by_name: 'Nisha Iyer',
  ...
  },
  {
    ...
    contact: 'Sanjay Paul',
    contacts: [
      { id: 'contact-4a', name: 'Sanjay Paul', designation: 'Admin Manager', phone: '+91 98765 24001', email: 'sanjay.paul@example.com', isPrimary: true },
    ],
    source: 'Partner',
    executive: 'Ananya Rao',
    assigned_bd_executive: 'Ananya Rao',
  ...
  },
  {
    ...
    contact: 'Priya Menon',
    contacts: [
      { id: 'contact-5a', name: 'Priya Menon', designation: 'Hospital Administrator', phone: '+91 98765 25001', email: 'priya.menon@example.com', isPrimary: true },
      { id: 'contact-5b', name: 'Jacob Thomas', designation: 'Maintenance Head', phone: '+91 98765 25002', email: 'jacob.thomas@example.com', isPrimary: false },
    ],
    source: 'Walk-in',
    executive: 'Ananya Rao',
    assigned_bd_executive: 'Ananya Rao',
